...
{
public:
    void testFilter(int idx, SelectionFilterTypesVariant filter);
    void testFilterSpanner(int idx, SelectionFilterTypesVariant filter);
};

void Engraving_SelectionFilterTests::testFilter(int idx, SelectionFilterTypesVariant filter)
{
...
void Engraving_SelectionFilterTests::testFilterSpanner(int idx, SelectionFilterTypesVariant filter)
{
