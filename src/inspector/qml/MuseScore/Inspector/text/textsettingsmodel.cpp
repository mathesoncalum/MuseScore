...
void TextSettingsModel::createProperties()
{
    ...
    m_fontFamily = buildPropertyItem(Pid::FONT_FACE, onPropertyChanged, nullptr, onPropertyReset);
    m_fontStyle = buildPropertyItem(Pid::FONT_STYLE, onPropertyChanged, nullptr, onPropertyReset);
    m_fontSize = buildPropertyItem(Pid::FONT_SIZE, onPropertyChanged, nullptr, onPropertyReset);
    m_textLineSpacing = buildPropertyItem(mu::engraving::Pid::TEXT_LINE_SPACING);

    m_horizontalAlignment = buildPropertyItem(Pid::ALIGN, [this, onPropertyChanged](const mu::engraving::Pid pid, const QVariant& newValue) {
    ...
    m_verticalAlignment = buildPropertyItem(Pid::ALIGN, [this, onPropertyChanged](const mu::engraving::Pid pid, const QVariant& newValue) {
    ...
    m_horizontalPosition = buildPropertyItem(Pid::POSITION, onPropertyChanged, nullptr, onPropertyReset);
...
void TextSettingsModel::propertyChangedCallback(const engraving::Pid propertyId, const QVariant& newValue)
{
    ...
    switch (propertyId) {
    case Pid::FONT_FACE:
        // Editing FONT_FACE will update BEGIN_FONT_FACE directly on the item (see TextLineBaseSegment)...
        setPropertyValue(m_elementList, Pid::CONTINUE_FONT_FACE, newValue);
        setPropertyValue(m_elementList, Pid::END_FONT_FACE, newValue);
        break;
    case Pid::FONT_SIZE:
        // Editing FONT_SIZE will update BEGIN_FONT_SIZE directly on the item (see TextLineBaseSegment)...
        setPropertyValue(m_elementList, Pid::CONTINUE_FONT_SIZE, newValue);
        setPropertyValue(m_elementList, Pid::END_FONT_SIZE, newValue);
        break;
    case Pid::FONT_STYLE:
        // Editing FONT_STYLE will update BEGIN_FONT_STYLE directly on the item (see TextLineBaseSegment)...
        ...
        break;
    case Pid::ALIGN:
        // Editing ALIGN will update BEGIN_TEXT_ALIGN directly on the item (see TextLineBaseSegment)...
