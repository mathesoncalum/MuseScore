...
protected:
    ...
    SelectionFilterTypesVariant getAll() const override { return engraving::ElementsSelectionFilterTypes::ALL; }
    SelectionFilterTypesVariant getNone() const override { return engraving::ElementsSelectionFilterTypes::NONE; }
