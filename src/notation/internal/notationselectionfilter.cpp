...
NotationSelectionFilter::NotationSelectionFilter(const IGetScore* getScore, INotationInteraction* interaction)
...
{
    // TODO NEXT TIME - selection filters doesn't have this method yet...
