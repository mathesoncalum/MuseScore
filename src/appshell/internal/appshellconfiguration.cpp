...
bool AppShellConfiguration::welcomeDialogBlocked() const
{
    return m_welcomeDialogBlocked;
}

void AppShellConfiguration::setWelcomeDialogBlocked(bool block)
{
    m_welcomeDialogBlocked = block;
}
