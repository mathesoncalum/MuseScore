...
Rectangle {
    ...
    readonly property bool hasTitleBar: frameModel.titleBarAllowed && !(frameModel.rowCount > 1 || frameModel.isHorizontalPanel)
    readonly property bool hasSingleTab: frameModel.titleBarAllowed && frameModel.rowCount === 1 && frameModel.isHorizontalPanel
    readonly property bool hasTabBar: frameModel.titleBarAllowed && (frameModel.rowCount > 1 || frameModel.isHorizontalPanel)
