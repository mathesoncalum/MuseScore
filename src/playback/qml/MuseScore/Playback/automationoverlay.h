...
private:
    ...
    void paintLane(muse::draw::Painter* painter, const AutomationLane& lane, size_t laneIndex);
    void paintBreakpoint(muse::draw::Painter* painter, const Breakpoint& breakpoint, bool selected);
    ...
    // TODO: optional?
    std::pair</*laneIndex*/ size_t, /*pointIndex*/ size_t> m_editedPoint = { 300, 300 };
};
}
